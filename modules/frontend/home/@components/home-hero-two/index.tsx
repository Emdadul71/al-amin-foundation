...
const HomeHero = () => {
  return (
    <section>
      <div className="min-h-[calc(100vh-88px)] lg:min-h-[calc(100vh-75px)] relative bg-[url('/images/test.jpg')] bg-center bg-no-repeat bg-cover">
        <div
          ...
          // }}
        ></div>
        <div className="max-w-[1020px] px-5 mx-auto min-h-[calc(100vh-88px)] lg:min-h-[calc(100vh-75px)] text-white relative z-10 ">
